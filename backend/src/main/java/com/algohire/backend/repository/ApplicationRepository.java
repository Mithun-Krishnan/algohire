...
public interface ApplicationRepository extends JpaRepository<Application, UUID>{
    ...
    List<Application> findByUsers_IdOrderByUpdatedAtDesc(UUID userId);
    List<Application> findByJobId_Id(UUID jobId);
    long countByJobIdCreatedById(UUID recruiterId);

    long countByJobIdCreatedByIdAndApplicationStatus(UUID recruiterId, ApplicationStatus status);
}
